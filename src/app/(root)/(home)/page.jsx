        ...
        <div className="max-w-[1332px] px-4 block mx-auto py-10">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="flex bg-linear border border-[#B4A4A4] rounded-[5px]">
                        ...
                        <div className="basis-[62%] flex flex-col gap-2 sm:gap-2.5 py-2 sm:px-[15px] px-2 sm:pr-2.5 py-2.5">
                            <h3 className="text-base font-bold leading-[1.1] overflow-hidden line-clamp-2 max-h-9">Stay tuned for a sneak peek at some exciting upcoming changes that will take your...</h3>
                            <div className="flex gap-[5px]">
                                <div className="py-[3px] text-sm leading-[1.1]  px-2.5 bg-[#EBE3D7] rounded-[5px] inline-flex">
                                    Глобальный
                                </div>
                                <div className="py-[3px] text-sm  leading-[1.1] px-2.5 bg-[#EBE3D7] rounded-[5px] inline-flex">
                                    +5
                            ...
                            <div className="text-xs flex leading-[1.1] font-normal gap-1">
                                <span>Автор:</span>
                                <img src="/assets/user.png" alt="" />
                                <span>Team Unification</span>
                            </div>
                            <div className="flex gap-6 leading-[1.1]">
                                <div className="flex items-center gap-2 text-[#222] font-normal text-xs">
                                    <img src="/assets/viewed.png" alt="" />
                                    16.08.2024
                                </div>
                                <div className="flex items-center gap-2 text-[#222] font-normal text-xs">
